...
as the message key. Use [StringConverter](https://kafka.apache.org/20/javadoc/org/apache/kafka/connect/storage/StringConverter.html) for Key.
...
#### Key generated by SMT. In case the field name is missing or empty in the body, the key will be "unnamed"
...
| Name              | Description                                                                                     | Type   | Default | Required | Importance |
|-------------------|-------------------------------------------------------------------------------------------------|--------|---------|----------|------------|
| `keyFieldMapping` | Map of key field name to json path in the message body. eg: field1:jsonpath1,field2:jsonpath2.. | String | null    | true     | High       |
...
#### Key generated by SMT. In case the field name is missing or empty in the body, the field value will be null
...
| Name                 | Description                                                                                        | Type   | Default | Required | Importance |
|----------------------|----------------------------------------------------------------------------------------------------|--------|---------|----------|------------|
| `headerFieldMapping` | Map of header field name to json path in the message body. eg: field1:jsonpath1,field2:jsonpath2.. | String | null    | true     | High       |
...
In case the field name is missing or empty in the body, the field value will be null
...
if it is already present. Use [StringConverter](https://kafka.apache.org/20/javadoc/org/apache/kafka/connect/storage/StringConverter.html) for Key.
...
| `keyOnError`         | Constant value to be used as key when there is an error                                            | String | null    | false    | Low        |
| `errorMessageField`  | Field name to be used when printing errors, use json path                                          | String | null    | false    | Low        |
| `headerFieldMapping` | Map of header field name to json path in the message body. eg: field1:jsonpath1,field2:jsonpath2.. | String | null    | false    | Medium     |
...
In case the field name is missing or empty in the body, the key will be "unnamed"
